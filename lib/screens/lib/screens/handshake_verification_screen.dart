        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (isVerified) const Padding(padding: EdgeInsets.only(top: 24), child: Text('✓ Handshake Complete!', style: TextStyle(fontSize: 18, color: Colors.green, fontWeight: FontWeight.bold))),
            ],
          ),
        ),
      ),
